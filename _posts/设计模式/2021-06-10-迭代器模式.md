...
![image-20210610142522868](../../assets/img/image-20210610142522868.png)
...
1. 声明迭代器接口。该接口必须提供至少一个方法来获取集合中的下个元素。但为了使用方便，你还可以添加一些其他方法，例如获取前一个元素、记录当前位置和判断迭代是否已经结束。
...
public class Demo {
    public static void main(String[] args) {
        ...
        bookShelf.addBook(new Book("追风筝的人"));
        bookShelf.addBook(new Book("偷影子的人"));
        bookShelf.addBook(new Book("伊斯坦布尔假期"));
        bookShelf.addBook(new Book("哲学家们都干了些什么"));
        bookShelf.addBook(new Book("未来简史"));
        Iterator it = bookShelf.iterator();
        while(it.hasNext()){
            Book next = (Book) it.getNext();
