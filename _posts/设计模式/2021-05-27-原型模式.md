...
> [以上摘自REFACTORING GURU](https://refactoringguru.cn/design-patterns/prototype)
...
public abstract class Monkey {
     ...
     * @return
     */
    public abstract Monkey cloneMethod();
}
```
...
```java
public class LiuErMiHou extends Monkey{
    private int abilityNum;

    public LiuErMiHou() {
    }

    public LiuErMiHou(LiuErMiHou liuErMiHou) {
        super(liuErMiHou);
        this.abilityNum = liuErMiHou.abilityNum;
    }

    @Override
    public Monkey cloneMethod() {
        return new LiuErMiHou(this);
    }
}
```

```java
public class TongBiYuanHou extends Monkey{
    private int crimeNum;

    public TongBiYuanHou() {
    }

    public TongBiYuanHou(TongBiYuanHou tongBiYuanHou) {
        super(tongBiYuanHou);
        this.crimeNum = tongBiYuanHou.crimeNum;
    }

    @Override
    public Monkey cloneMethod() {
        return new TongBiYuanHou(this);
    }
}
```
...
public class MonkeyCache {
    private Map<String, Monkey> cache = new HashMap<>();

    public MonkeyCache() {
        LiuErMiHou m1 = new LiuErMiHou();
        m1.setName("六耳猕猴");
        m1.setAge(1000);
        m1.setAbilityNum(50);

        TongBiYuanHou m2 = new TongBiYuanHou();
        m2.setName("通臂猿猴");
        m2.setAge(990);
        m2.setCrimeNum(10000);

        cache.put("m1", m1);
        cache.put("m2", m2);
    }

    public void put(String key, Monkey monkey){
        cache.put(key, monkey);
    }

    public Monkey get(String key){
        return cache.get(key).cloneMethod();
    }
}
```
...
public class Demo {
    public static void main(String[] args) {
        MonkeyCache cache = new MonkeyCache();
        Monkey m1 = cache.get("m1");
        Monkey m2 = cache.get("m2");
        System.out.println(m1.toString());
        System.out.println(m2.toString());
    }
}

//LiuErMiHou(abilityNum=50)
//TongBiYuanHou(crimeNum=10000)
```
