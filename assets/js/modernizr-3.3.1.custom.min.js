...
!function (e, t, n) {
    ...
    function h(e, t, o, i) {
        ...
        for (p = e.length, d = 0; p > d; d++) if (h = e[d], v = k.style[h], s(h, "-") && (h = a(h)), k.style[h] !== n) {
    ...
    var _ = "Moz O ms Webkit", w = E._config.usePrefixes ? _.toLowerCase().split(" ") : [];
    E._domPrefixes = w;
    ...
    E.testAllProps = g, Modernizr.addTest("cssanimations", g("animationName", "a", !0)), Modernizr.addTest("csstransitions", g("transition", "all", !0)), o(), i(y), delete E.addTest, delete E.addAsyncTest;
